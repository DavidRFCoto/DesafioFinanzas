...
<head>
    ...
    <style>
        ...
        .form-container h2 {
            ...
            color: #333;
            margin-bottom: 25px;
            border-bottom: 2px solid #e74c3c; /* Color diferente para Salidas */
            padding-bottom: 10px;
        }
        .form-group {
            margin-bottom: 20px;
        ...
        .form-group textarea:focus {
            border-color: #e74c3c; /* Color diferente para Salidas */
            outline: none;
        }
        .form-container button {
            width: 100%;
            padding: 15px;
            background-color: #e74c3c; /* Rojo para Salidas */
            color: white;
            border: none;
            border-radius: 8px;
            font-size: 18px;
    ...
    <div class="form-container">
        ...
        <form method="POST" action="procesar_salida.php">
            <div class="form-group">
                ...
                <input type="text" id="concepto_salida" name="concepto" placeholder="Ej: Salario, Prestamo..." required>
            </div>
            <div class="form-group">
