        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <li class="nav-item">
                        <a href="RegistrarSalida.php" class="nav-link active">
                    ...
                    <div class="col-md-12">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">Nueva Salida de Dinero</h3>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="concepto_salida" name="concepto" 
                                                   placeholder="Ej: Alquiler, Servicios..." required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="monto_salida" name="monto" 
                                                   step="0.01" placeholder="0.00" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="fecha_salida">Fecha de Transacción</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                            ...
                                            <input type="date" 
                                                   ...
                                                   id="fecha_salida" 
                                                   name="fecha" 
                                                   value="<?php echo $fecha_actual->format('Y-m-d'); ?>" 
                                                   max="<?php echo $fecha_actual->format('Y-m-d'); ?>"
                                                   pattern="\d{4}-\d{2}-\d{2}"
                                                   required
                                    ...
                                    <div class="form-group">
                                        <label for="descripcion_salida">Descripción (Opcional)</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                            ...
                                            <textarea class="form-control" id="descripcion_salida" name="descripcion" 
