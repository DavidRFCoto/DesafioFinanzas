        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <li class="nav-item">
                        <a href="EntradasLista.php" class="nav-link active">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                <canvas id="entradasPorMes" height="250"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <canvas id="distribucionEntradas" height="250"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if ($resultado && $resultado->num_rows > 0) {
                            ...
                            echo '<table id="tablaEntradas" class="table table-bordered table-striped">';
                            echo '<thead>
                                    <tr>
                                        <th>Concepto</th>
                                        <th>Monto</th>
                            ...
                            echo '<div class="alert alert-info">
                                    <i class="fas fa-info-circle"></i> No hay entradas registradas.
                                  </div>';
                        }
                        ?>
                    </div>
...
$(function () {
    ...
    var ctxMes = document.getElementById('entradasPorMes').getContext('2d');
    ...
    new Chart(ctxMes, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Total de Entradas por Mes',
    ...
    var ctxDist = document.getElementById('distribucionEntradas').getContext('2d');
